...
/**
 * Shared Zod schemas for the onboarding wizard.
 *
 * Previously in src/lib/validations.ts, migrated to the
 * src/lib/validations/ directory for organization.
 */
...
/** Combined schema for the merged Details & Access step (all optional). */
...
export type Step3DetailsValues = z.infer<typeof step3DetailsSchema>;
