...
- **Starter Bundle**: Perfect for businesses just getting started with AI marketing. Includes core services like AI Chatbot, Review Management, and Content Engine.
- **Growth Bundle**: Our most popular plan. Includes everything in Starter plus Email Marketing, Social Media, SEO, and Voice Agent.
- **Empire Bundle**: The full suite of 16 AI services for maximum growth. Includes advanced features like Ad Management, Revenue Attribution, and Quarterly Business Reviews.
...
New subscribers start with a free trial period to experience the platform before committing. During the trial, you have full access to your selected plan's features. No credit card is required to start.

## Subscription Management

You can manage your subscription directly from your dashboard under Billing. View your current plan, see your next billing date, and access your payment history. All billing is handled securely through Stripe.`,
  },
  {
...
For critical issues outside business hours (such as complete service outage or security concerns), email emergency@sovereignai.com. This channel is monitored 24/7.`,
  },
];
