...
const demoLeads: DashboardLead[] = [
  { id: "demo-1", name: "John Miller", email: "john@miller.com", phone: "(214) 555-0142", source: "website", status: "qualified", date: new Date(Date.now() - 1000 * 60 * 30).toISOString() },
  { id: "demo-2", name: "Lisa Park", email: "lisa@parkresidential.com", phone: "(972) 555-0198", source: "chatbot", status: "appointment", date: new Date(Date.now() - 1000 * 60 * 60 * 2).toISOString() },
  { id: "demo-3", name: "Robert Davis", email: "", phone: "(469) 555-0231", source: "phone", status: "new", date: new Date(Date.now() - 1000 * 60 * 60 * 4).toISOString() },
  { id: "demo-4", name: "Maria Garcia", email: "maria.g@email.com", phone: "(817) 555-0167", source: "referral", status: "won", date: new Date(Date.now() - 1000 * 60 * 60 * 8).toISOString() },
  { id: "demo-5", name: "Tom Wilson", email: "twilson@email.com", phone: "(214) 555-0293", source: "form", status: "qualified", date: new Date(Date.now() - 1000 * 60 * 60 * 12).toISOString() },
  { id: "demo-6", name: "Amy Chen", email: "amy.chen@outlook.com", phone: "(469) 555-0311", source: "chatbot", status: "new", date: new Date(Date.now() - 1000 * 60 * 60 * 16).toISOString() },
];
...
const demoServices = [
  ...
  { serviceId: "chatbot", status: "configuring", activatedAt: "2026-03-20T00:00:00Z" },
  { serviceId: "social", status: "configuring", activatedAt: "2026-03-22T00:00:00Z" },
];
