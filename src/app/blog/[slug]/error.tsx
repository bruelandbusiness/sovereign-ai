    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background">
      <Container>
        <div className="mx-auto max-w-md text-center" role="alert" aria-live="assertive">
          ...
          <h1 className="text-xl font-semibold">Unable to load blog post</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            We had trouble loading this blog post. Please try again or head back
            to the blog.
          </p>
          {error.digest && (
          ...
          <div className="mt-6 border-t border-border pt-4">
            <a
              href={`mailto:support@trysovereignai.com?subject=Blog Post Error${error.digest ? ` (${error.digest})` : ""}&body=I encountered an error loading a blog post.`}
