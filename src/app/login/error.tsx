      ...
      <Container>
        <div className="mx-auto max-w-md text-center" role="alert" aria-live="assertive">
          ...
          <h1 className="text-xl font-semibold">
            Something went wrong loading login
          </h1>
          <p className="mt-2 text-sm text-muted-foreground">
            We had trouble loading the login page. Please try again or
          ...
          <div className="mt-6 border-t border-border pt-4">
            <a
              href={`mailto:support@trysovereignai.com?subject=Login Error${error.digest ? ` (${error.digest})` : ""}&body=I encountered an error on the login page.`}
