      ...
      <Container>
        <div className="mx-auto max-w-md text-center" role="alert" aria-live="assertive">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            We had trouble loading the community page. Please try again or
          ...
          <div className="mt-6 border-t border-border pt-4">
            <a
              href={`mailto:support@trysovereignai.com?subject=Community Error${error.digest ? ` (${error.digest})` : ""}&body=I encountered an error on the community page.`}
