...
export default function FreeAuditError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    Sentry.captureException(error, {
      tags: { boundary: "free-audit-error" },
      ...
      <Container>
        <div className="mx-auto max-w-md text-center" role="alert" aria-live="assertive">
          ...
          <h1 className="text-xl font-semibold">
            Something went wrong loading the free audit
          </h1>
          <p className="mt-2 text-sm text-muted-foreground">
            We had trouble loading the free audit page. Please try again or
          ...
          <div className="mt-6 border-t border-border pt-4">
            <a
              href={`mailto:support@trysovereignai.com?subject=Free Audit Error${error.digest ? ` (${error.digest})` : ""}&body=I encountered an error on the free-audit page.`}
