...
export default function EstimatePage() {
  ...
  if (step === "analyzing") {
    return (
      <div className="min-h-screen bg-background text-foreground flex items-center justify-center p-6" role="status" aria-live="polite">
        <div className="max-w-md text-center">
      ...
      <div className="min-h-screen bg-background text-foreground">
        <div className="mx-auto max-w-lg px-4 py-8 sm:py-12">
          ...
          <div className="mb-6 rounded-xl border border-border bg-secondary p-5">
            <h3 className="mb-1 text-sm font-semibold text-muted-foreground uppercase tracking-wide">
              Issue Detected
            </h3>
          ...
          <button
            type="button"
            className="w-full rounded-xl gradient-bg px-6 py-4 text-lg font-bold text-white transition-opacity hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            onClick={() => {
              // Navigate to the contact/booking page
              if (clientId) {
                window.location.href = `/contact?ref=estimate&biz=${encodeURIComponent(clientId)}`;
              } else {
                window.location.href = "/contact?ref=estimate";
              }
            }}
          >
            Book a Technician
          ...
          <button
            type="button"
            className="mt-6 w-full rounded-lg border border-border bg-secondary py-3 text-sm font-medium text-muted-foreground transition-colors hover:bg-secondary/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            onClick={handleReset}
          >
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      {/* Hero */}
      <div className="bg-gradient-to-br from-secondary to-background py-10 sm:py-16 px-4 text-center">
      ...
      <div className="mx-auto max-w-lg px-4 py-8">
        ...
        <div className="space-y-4">
          {/* Issue type */}
          <div>
            <label htmlFor="estimate-vertical" className="mb-1.5 block text-xs font-semibold uppercase tracking-wider text-muted-foreground">
              Issue Type
            </label>
            <select
              ...
              className="w-full rounded-lg border border-border bg-secondary px-4 py-3 text-sm text-foreground outline-none transition-colors focus:border-primary focus-visible:ring-2 focus-visible:ring-primary/50"
            >
          ...
          {/* Name */}
          <div>
            <label htmlFor="estimate-name" className="mb-1.5 block text-xs font-semibold uppercase tracking-wider text-muted-foreground">
            ...
            <input
              ...
              className="w-full rounded-lg border border-border bg-secondary px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground outline-none transition-colors focus:border-primary focus-visible:ring-2 focus-visible:ring-primary/50"
            />
          </div>

          {/* Phone */}
          <div>
            <label htmlFor="estimate-phone" className="mb-1.5 block text-xs font-semibold uppercase tracking-wider text-muted-foreground">
          ...
          {/* Email */}
          <div>
            <label htmlFor="estimate-email" className="mb-1.5 block text-xs font-semibold uppercase tracking-wider text-muted-foreground">
        ...
        <button
          ...
          className="mt-6 w-full rounded-xl gradient-bg px-6 py-4 text-lg font-bold text-white transition-opacity hover:opacity-90 disabled:opacity-40 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
        >
