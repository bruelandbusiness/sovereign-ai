...
export const metadata: Metadata = {
  ...
  description:
    "Get instant AI-generated repair estimates from a photo. Snap a picture of your HVAC, plumbing, roofing, or electrical issue and receive a ballpark price in seconds — no obligation.",
  openGraph: {
    title: "AI-Powered Estimates | Sovereign AI",
    description:
