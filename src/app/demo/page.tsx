...
import { Target, ArrowRight, Sparkles, Play } from "lucide-react";
    ...
    <div className="flex min-h-screen flex-col bg-background page-enter">
      <JsonLd
        data={{
          ...
          name: "Sovereign AI Marketing Dashboard",
          applicationCategory: "BusinessApplication",
          operatingSystem: "Web",
          description:
            "Interactive demo of the Sovereign AI marketing dashboard. See real-time lead tracking, AI service management, and performance analytics.",
          offers: {
            "@type": "Offer",
            price: "0",
            priceCurrency: "USD",
            description: "Free demo — no account required",
          },
        }}
      />
      <BreadcrumbJsonLd
