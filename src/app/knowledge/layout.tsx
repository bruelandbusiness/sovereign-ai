...
export const metadata: Metadata = {
  ...
  description:
    "Find answers, guides, and resources to get the most out of Sovereign AI. Browse our help center for onboarding tutorials, feature guides, billing info, and troubleshooting tips.",
  openGraph: {
    title: "Knowledge Base | Sovereign AI",
    description:
