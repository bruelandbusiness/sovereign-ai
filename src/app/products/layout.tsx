...
export const metadata: Metadata = {
  ...
  description:
    "Enterprise-grade AI tools, agents, and templates built for businesses that want to lead. Browse Sovereign AI's digital product catalog — from infrastructure solutions to revenue-driving SaaS tools.",
  openGraph: {
    title: "Digital Products | Sovereign AI",
    description:
