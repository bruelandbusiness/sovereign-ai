      ...
      <Container>
        <div className="mx-auto max-w-md text-center" role="alert" aria-live="assertive">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            We had trouble loading the products page. Please try again or return
            to the home page.
          </p>
          {error.digest && (
          ...
          <div className="mt-6 border-t border-border pt-4">
            <a
              href={`mailto:support@trysovereignai.com?subject=Products Page Error${error.digest ? ` (${error.digest})` : ""}&body=I encountered an error on the products page.`}
