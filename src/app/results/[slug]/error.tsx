...
export default function ResultsDetailError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    Sentry.captureException(error, {
      tags: { boundary: "results-detail-error" },
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background">
      <Container>
        <div className="mx-auto max-w-md text-center" role="alert" aria-live="assertive">
          ...
          <h1 className="text-xl font-semibold">Unable to load case study</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            We had trouble loading this case study. Please try again or browse
            all case studies.
          </p>
          {error.digest && (
          ...
          <div className="mt-6 border-t border-border pt-4">
            <a
              href={`mailto:support@trysovereignai.com?subject=Case Study Error${error.digest ? ` (${error.digest})` : ""}&body=I encountered an error loading a case study.`}
