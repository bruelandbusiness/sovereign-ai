...
export const alt = "Free AI Marketing Audit — Sovereign AI";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          >
            Discover hidden revenue leaks in your marketing. 60-second analysis
            for HVAC, plumbing, roofing & home service businesses.
          </div>
        </div>
