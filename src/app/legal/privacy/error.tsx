...
export default function PrivacyPolicyError({
  ...
  useEffect(() => {
    Sentry.captureException(error, {
      tags: { boundary: "privacy-policy-error" },
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background">
      <Container>
        <div className="mx-auto max-w-md text-center" role="alert" aria-live="assertive">
          ...
          <h1 className="mt-4 text-xl font-semibold">Unable to load privacy policy</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            We had trouble loading the privacy policy page. Please try again.
          </p>
