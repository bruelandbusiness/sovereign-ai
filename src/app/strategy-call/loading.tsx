export default function StrategyCallLoading() {
  return (
    <div className="flex min-h-screen flex-col bg-background" role="status" aria-label="Loading strategy call">
      {/* Header placeholder */}
            ...
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <div className="skeleton mb-1 h-5 w-3/4" />
