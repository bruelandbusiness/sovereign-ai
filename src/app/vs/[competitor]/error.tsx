...
export default function CompetitorComparisonError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    Sentry.captureException(error, {
      tags: { boundary: "competitor-comparison-error" },
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background">
      <Container>
        <div className="mx-auto max-w-md text-center" role="alert" aria-live="assertive">
          ...
          <h1 className="text-xl font-semibold">Unable to load comparison</h1>
          <p className="mt-2 text-sm text-muted-foreground">
            We had trouble loading this comparison page. Please try again or
          ...
          <div className="mt-6 border-t border-border pt-4">
            <a
              href={`mailto:support@trysovereignai.com?subject=Comparison Error${error.digest ? ` (${error.digest})` : ""}&body=I encountered an error on a comparison page.`}
