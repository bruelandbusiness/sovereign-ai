...
export const metadata: Metadata = {
  ...
  description:
    "Connect with top-rated, AI-powered home service professionals in your area. Get free quotes from verified pros who use cutting-edge AI to deliver better results.",
  openGraph: {
    title: "Find a Pro Near You | Sovereign AI",
    description:
