...
(function() {
  ...
  style.textContent = [
    ...
    '.sov-msg { max-width: 82%; padding: 10px 14px; border-radius: 14px; font-size: 14px; line-height: 1.5; color: ' + TEXT + '; word-wrap: break-word; white-space: pre-wrap; }',
    '.sov-msg-assistant { align-self: flex-start; background: ' + BG_PANEL + '; border: 1px solid ' + BORDER + '; border-bottom-left-radius: 4px; }',
    '.sov-msg-user { align-self: flex-end; background: ' + PRIMARY + '; color: #fff; border-bottom-right-radius: 4px; }',

    /* -- Typing indicator -- */
    '.sov-typing { align-self: flex-start; display: flex; gap: 5px; padding: 10px 16px; }',
    '.sov-typing-dot { width: 8px; height: 8px; border-radius: 50%; background: ' + TEXT_MUTED + '; animation: sovBounce 1.4s infinite ease-in-out both; }',
    '.sov-typing-dot:nth-child(1) { animation-delay: -0.32s; }',
