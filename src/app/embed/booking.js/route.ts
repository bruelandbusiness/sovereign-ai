...
(function() {
  ...
  style.textContent = [
    ...
    '#sov-booking .sov-booking-step-title { color: #fff; font-size: 14px; font-weight: 600; margin-bottom: 12px; }',
    '#sov-booking .sov-booking-subtitle { color: ' + TEXT_MUTED + '; font-size: 12px; margin-bottom: 12px; }',

    '#sov-booking .sov-date-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 8px; }',
    '#sov-booking .sov-date-btn { background: ' + BG_PANEL + '; border: 1px solid ' + BORDER + '; border-radius: 10px; padding: 10px 8px; cursor: pointer; color: ' + TEXT + '; text-align: center; transition: all 0.15s; }',
    '#sov-booking .sov-date-btn:hover { border-color: ' + PRIMARY + '; }',
    '#sov-booking .sov-date-btn.selected { background: ' + PRIMARY + '; border-color: ' + PRIMARY + '; color: #fff; }',
    '#sov-booking .sov-date-btn .day { font-size: 11px; color: ' + TEXT_MUTED + '; margin-bottom: 2px; }',
    '#sov-booking .sov-date-btn.selected .day { color: rgba(255,255,255,0.8); }',
    '#sov-booking .sov-date-btn .num { font-size: 16px; font-weight: 700; }',
    '#sov-booking .sov-date-btn.empty { visibility: hidden; pointer-events: none; }',

    '#sov-booking .sov-time-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 8px; }',
    '#sov-booking .sov-time-btn { background: ' + BG_PANEL + '; border: 1px solid ' + BORDER + '; border-radius: 10px; padding: 10px; cursor: pointer; color: ' + TEXT + '; text-align: center; font-size: 13px; font-weight: 500; transition: all 0.15s; }',
    '#sov-booking .sov-time-btn:hover { border-color: ' + PRIMARY + '; }',
    '#sov-booking .sov-time-btn.selected { background: ' + PRIMARY + '; border-color: ' + PRIMARY + '; color: #fff; }',

    '#sov-booking .sov-booking-form { display: flex; flex-direction: column; gap: 10px; }',
    '#sov-booking .sov-booking-label { display: block; color: ' + TEXT_MUTED + '; font-size: 12px; font-weight: 600; margin-bottom: 2px; }',
    '#sov-booking .sov-booking-input { width: 100%; background: ' + BG_INPUT + '; border: 1px solid ' + BORDER + '; border-radius: 10px; padding: 10px 14px; color: ' + TEXT + '; font-size: 14px; outline: none; }',
    '#sov-booking .sov-booking-input::placeholder { color: ' + TEXT_MUTED + '; }',
    '#sov-booking .sov-booking-input:focus { border-color: ' + PRIMARY + '; }',

    '#sov-booking .sov-booking-submit { width: 100%; background: ' + PRIMARY + '; border: none; border-radius: 10px; padding: 12px; color: #fff; font-size: 14px; font-weight: 600; cursor: pointer; transition: opacity 0.15s; margin-top: 4px; }',
    '#sov-booking .sov-booking-submit:disabled { opacity: 0.5; cursor: not-allowed; }',
    '#sov-booking .sov-booking-submit:hover:not(:disabled) { opacity: 0.9; }',

    '#sov-booking .sov-booking-back { background: none; border: none; color: ' + TEXT_MUTED + '; cursor: pointer; font-size: 12px; padding: 4px 0; transition: color 0.15s; }',
    '#sov-booking .sov-booking-back:hover { color: ' + TEXT + '; }',

    '#sov-booking .sov-booking-success { text-align: center; padding: 20px 0; }',
    '#sov-booking .sov-booking-success svg { width: 48px; height: 48px; margin: 0 auto 12px; }',
    '#sov-booking .sov-booking-success h3 { color: #fff; font-size: 18px; margin-bottom: 8px; }',
    '#sov-booking .sov-booking-success p { color: ' + TEXT_MUTED + '; font-size: 13px; }',

    '#sov-booking .sov-no-slots { text-align: center; color: ' + TEXT_MUTED + '; padding: 20px 0; font-size: 13px; }',
    '#sov-booking .sov-booking-spinner { display: inline-block; width: 16px; height: 16px; border: 2px solid ' + BORDER + '; border-top-color: ' + PRIMARY + '; border-radius: 50%; animation: sovBookingSpin 0.6s linear infinite; vertical-align: middle; margin-right: 6px; }',
