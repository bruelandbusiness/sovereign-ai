      ...
      <main className="flex-1 py-8" aria-label="Reports page">
        <Container>
          ...
          {!isLoading && periods.length === 0 && (
            <EmptyState
              icon={FileText}
              title="Your first report is on the way"
              description="Reports are generated weekly once enough data has been collected. Your first report arrives next Monday with a full breakdown of leads, conversions, and ROI."
              actionLabel="Back to Dashboard"
              actionHref="/dashboard"
              secondaryLabel="View Performance Now"
              secondaryHref="/dashboard/performance"
            />
          )}
          {!isLoading && periods.length > 0 && (
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
