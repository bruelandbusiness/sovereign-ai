...
export const metadata: Metadata = {
  title: "60-Day Results Guarantee | Sovereign AI",
  description:
...
const faqs = [
  ...
  },
  {
    ...
    a: "Email support@sovereignai.com or submit a ticket in your dashboard. We process refunds within 5 business days.",
  },
  {
            ...
            <FadeInView>
              <div className="text-center">
                ...
                <p className="mt-4 text-muted-foreground">
                  Join hundreds of service businesses already growing with guaranteed AI marketing.
                </p>
