...
export async function GET(request: Request) {
  try {
    ...
    logger.errorWithCause("[aeo/strategies] GET failed:", err);
...
export async function POST(request: Request) {
  try {
    ...
    logger.errorWithCause("[aeo/strategies] POST failed:", err);
...
export async function PUT(request: Request) {
  try {
    ...
    logger.errorWithCause("[aeo/strategies] PUT failed:", err);
    return NextResponse.json(
...
Return ONLY the JSON array, no other text.`,
  ...
  try {
    ...
    logger.error("[aeo/strategies] Failed to parse AI response");
  }
