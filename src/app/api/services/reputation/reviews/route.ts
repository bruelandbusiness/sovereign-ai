...
export async function GET() {
  try {
    ...
    logger.errorWithCause("[reputation/reviews] GET failed:", err);
...
export async function POST(request: Request) {
  try {
    ...
    }).catch((err) => logger.errorWithCause("[reviews] Webhook dispatch failed:", err instanceof Error ? err.message : err));
    ...
    logger.errorWithCause("[reputation/reviews] POST failed:", err);
    return NextResponse.json(
