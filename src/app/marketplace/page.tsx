...
const ServiceDetailModal = dynamic(
  () => import("@/components/marketplace/ServiceDetailModal").then((m) => m.ServiceDetailModal),
  { ssr: false }
);
const BundleSection = dynamic(
  () => import("@/components/marketplace/BundleSection").then((m) => m.BundleSection),
  { ssr: true }
);
