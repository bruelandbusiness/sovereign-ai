          ...
          <div className="mx-auto mt-10 max-w-4xl rounded-2xl border border-border/50 glass-card p-6 sm:p-8">
            <div className="grid gap-8 lg:grid-cols-2">
              ...
              <div className="space-y-6">
                <div>
                  <label htmlFor="roi-vertical" className="mb-2 block text-sm font-medium">Your Industry</label>
                  <select
                    id="roi-vertical"
                    value={vertical}
                ...
                <div>
                  <label htmlFor="roi-job-value" className="mb-2 block text-sm font-medium">
                    Average Job Value ($)
                  </label>
                  <input
                    id="roi-job-value"
                ...
                <div>
                  <label htmlFor="roi-current-leads" className="mb-2 block text-sm font-medium">
                    Current Leads Per Month
                  </label>
                  <input
                    id="roi-current-leads"
                    type="number"
                    value={currentLeads}
                ...
                <button
                  ...
                  className="w-full rounded-lg gradient-bg py-3 font-semibold text-white transition-opacity hover:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                >
                  Calculate My ROI
                </button>
              </div>
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  ...
                  <div className="rounded-xl border border-border/50 bg-accent/5 p-4 text-center">
                    <DollarSign className="mx-auto mb-1 h-5 w-5 text-accent" aria-hidden="true" />
                  ...
                  <div className="rounded-xl border border-border/50 bg-card p-4 text-center">
                    <DollarSign className="mx-auto mb-1 h-5 w-5 text-foreground" aria-hidden="true" />
                  ...
                  <div className="rounded-xl border border-primary/30 bg-primary/10 p-4 text-center">
                    <TrendingUp className="mx-auto mb-1 h-5 w-5 text-primary" aria-hidden="true" />
                    <p className="text-2xl font-bold text-primary">
                      {calculated ? (
