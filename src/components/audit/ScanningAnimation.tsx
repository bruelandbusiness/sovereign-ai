    ...
    <section className="relative flex min-h-[60vh] items-center justify-center overflow-hidden py-24">
      ...
      <Container size="sm">
        ...
        >
          ...
          {/* Progress bar */}
          <div className="mb-8 w-full max-w-md" role="progressbar" aria-valuenow={Math.round(progress)} aria-valuemin={0} aria-valuemax={100} aria-label={`Scanning progress: ${Math.round(progress)}%`}>
