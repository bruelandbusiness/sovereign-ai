...
const stats = [
  ...
  { icon: Clock, value: "< 30s", label: "Instant Analysis" },
  { icon: BarChart3, value: "100%", label: "Free Forever" },
  { icon: AlertTriangle, value: "AI", label: "Powered Insights" },
];

const tickerItems = [
  "Scanning SEO, reviews, ads, social, and website performance",
  "Analyzing local competitor positioning in your market",
  "Checking Google Business Profile optimization",
  "Evaluating lead capture and conversion funnel",
];
