...
export function ProCard({ pro, onRequestQuote }: ProCardProps) {
  ...
  return (
    <div className="group relative rounded-xl border border-border/50 glass-card p-6 transition-all hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5 focus-within:border-primary/30 focus-within:ring-2 focus-within:ring-ring">
      {/* AI-Powered Badge */}
