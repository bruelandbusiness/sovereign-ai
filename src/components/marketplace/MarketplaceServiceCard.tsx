...
export function MarketplaceServiceCard({
  ...
  return (
    <motion.div
      ...
      className="group relative flex flex-col rounded-xl border border-border/60 glass-card p-6 transition-all duration-300 hover:-translate-y-1 hover:border-primary/30 hover:glow-primary"
    >
      {service.popular && (
        <Badge
          variant="default"
      ...
      <div className="flex gap-2">
        <Link href={`/onboarding?service=${service.id}`} className="flex-1">
