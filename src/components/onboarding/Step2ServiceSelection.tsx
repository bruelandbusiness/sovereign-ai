...
import { ArrowLeft, ArrowRight, ShoppingCart, Sparkles, Tag, AlertCircle } from "lucide-react";
    ...
    <div className="flex flex-col gap-6">
      ...
      {error && (
        <div
          ref={errorRef}
          role="alert"
          className="flex items-center gap-2 rounded-lg border border-destructive/30 bg-destructive/10 px-4 py-3 animate-[shake_0.3s_ease-in-out]"
        >
